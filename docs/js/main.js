const I18N = {
    en: {
        ...
        tag_install: "&lt;install&gt;",
        hero_tagline: "Offline Vulnerability Scanner with AI Triage",
        hero_sub: "Scan your dependencies for known CVEs without sending data anywhere.<br>AI-powered analysis runs entirely on your machine.",
    ...
    pt: {
        ...
        hero_tagline: "Scanner Offline de Vulnerabilidades com Triagem por IA",
        hero_sub: "Escaneie suas dependencias em busca de CVEs conhecidas sem enviar dados para lugar nenhum.<br>A analise com IA roda inteiramente na sua maquina.",
        get_started: "Comecar",
