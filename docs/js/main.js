const I18N = {
    en: {
        ...
        nav_api: "API",
        tag_api: "&lt;api&gt;",
        api_section_title: "Python API Reference",
        api_intro: "Use VulnHunter as a Python library to integrate vulnerability scanning into your own tools and workflows.",
        api_scan_title: "Scan Dependencies",
        api_scan_desc: "The <code>analyze()</code> function takes a database and a list of dependencies, returning a <code>ScanResult</code> with all matched vulnerabilities sorted by severity.",
        api_triage_title: "AI Triage",
        api_triage_desc: "The <code>TriageEngine</code> sends each vulnerability to a local Ollama LLM along with code references found by <code>CodeAnalyzer</code>, returning contextual risk assessments.",
        api_export_title: "Export Reports",
        api_export_desc: "Use <code>render_xlsx()</code> to generate styled Excel reports, or access the <code>ScanResult</code> model directly for custom integrations.",
        api_full_link: "Full API Documentation (Markdown)",
    ...
    pt: {
        ...
        nav_api: "API",
        tag_api: "&lt;api&gt;",
        api_section_title: "Referencia da API Python",
        api_intro: "Use o VulnHunter como biblioteca Python para integrar escaneamento de vulnerabilidades nas suas ferramentas e workflows.",
        api_scan_title: "Escanear Dependencias",
        api_scan_desc: "A funcao <code>analyze()</code> recebe um banco de dados e uma lista de dependencias, retornando um <code>ScanResult</code> com todas as vulnerabilidades encontradas ordenadas por severidade.",
        api_triage_title: "Triagem IA",
        api_triage_desc: "O <code>TriageEngine</code> envia cada vulnerabilidade para uma LLM local via Ollama junto com referencias de codigo encontradas pelo <code>CodeAnalyzer</code>, retornando avaliacoes contextuais de risco.",
        api_export_title: "Exportar Relatorios",
        api_export_desc: "Use <code>render_xlsx()</code> para gerar relatorios Excel estilizados, ou acesse o modelo <code>ScanResult</code> diretamente para integracoes customizadas.",
        api_full_link: "Documentacao Completa da API (Markdown)",
